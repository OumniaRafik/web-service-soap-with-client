...
public class ObjectFactory {
    ...
    private static final QName _GetCompteByCode_QNAME = new QName("http://ws/", "getCompteByCode");
    private static final QName _GetCompteByCodeResponse_QNAME = new QName("http://ws/", "getCompteByCodeResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws/", name = "getCompteByCode")
     ...
     */
    @XmlElementDecl(namespace = "http://ws/", name = "getCompteByCodeResponse")
