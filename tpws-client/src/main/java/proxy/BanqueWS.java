 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:1997/?wsdl")
    ...
    extends Service
{
     ...
     * 
     * @return
     *     returns BanqueController
     */
    @WebEndpoint(name = "BanqueControllerPort")
    public BanqueController getBanqueControllerPort() {
        return super.getPort(new QName("http://ws/", "BanqueControllerPort"), BanqueController.class);
    }
     ...
     */
    @WebEndpoint(name = "BanqueControllerPort")
    public BanqueController getBanqueControllerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "BanqueControllerPort"), BanqueController.class, features);
    }
